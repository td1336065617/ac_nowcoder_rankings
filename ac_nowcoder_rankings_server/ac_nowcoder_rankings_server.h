...
namespace ac_nowcoder_rankings_server {
    ...
    private:
        ...
        map<long long int, mutex> nowcoder_contest_set_mtx;
        mutex nowcoder_contest_set_mtx_mtx;
        ...
        map<long long int, mutex> nowcoder_contest_map_mtx;
        mutex nowcoder_contest_map_mtx_mtx;

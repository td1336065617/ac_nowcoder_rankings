        ...
        try {
            ...
            try {
                ...
                for (auto &evaluation_Data: Memorize_the_assessment_records[contestId]) {
                    // 为每条记录设置详细信息
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["submissionId"] =
                    ...
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["language"] =
                            evaluation_Data.second.get_language();  // 编程语言
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["userName"] =
                    ...
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["colorLevel"] =
                            evaluation_Data.second.get_color_level();  // 颜色等级
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["statusMessage"]
                            = evaluation_Data.second.get_status_message();  // 状态信息
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["submitTime"] =
                    ...
                    ac_nowcoder_contest_info_json["contest_infos"][evaluation_Data.second.get_submission_id()]["problemId"] =
            ...
            return ac_nowcoder_contest_info_str;  // 返回JSON字符串
        }
        catch (const std::exception& e) {
            // 返回错误信息的JSON
